...
Senior Backend Engineer with over 14 years of experience designing scalable systems, now leveraging a strong hybrid skill set across Java (Backend) and Kotlin (Mobile/Android). Proven track record working as a Remote Contractor for UK-based companies, delivering high-quality solutions in English-speaking environments.
...
* **API Architecture:** Led the development of a core Java-based API within a multi-tenant microservices architecture for high-profile clients like Boeing, Dr. Martens, and Hitachi.
* **Analytics & Reporting:** Built a complete Reporting module from scratch and developed custom analytics visualizations using Elasticsearch and Kibana.
* **Security & Auth:** Implemented OAuth2 authorisation and significantly enhanced API security with granular user roles.
* **DevOps & Automation:** Automated deployment pipelines using Bash scripts, CRON jobs, and Jenkins.
* **Technical Leadership:** Actively involved in architectural decisions, strategic planning, and onboarding new hires.
...
* **Contracting Transition:** Successfully transitioned from full-time employee to independent contractor, demonstrating strong self-management and reliability in a 100% remote setup.
* **Performance Tuning:** Focused on performance optimisations and backend support during critical system upgrades.
...
* **Full Lifecycle Delivery:** Managed the full software lifecycle: planning, implementation, deployment, and maintenance for multiple client startups.
* **Client Engagement:** Built back-office applications and led client demos and requirement gathering sessions.
* **Mentorship:** Mentored junior developers and introduced modern frameworks to improve development efficiency.
...
* **Requirements Analysis:** Gathered requirements and authored technical analysis documents for government modernization projects.
* **Release & Deployment:** Led configuration, testing, and deployment in integration environments.
...
* **Core Development:** Delivered new functionalities for the "HAPR" system (Telematic Authorisation) for the Junta de Andalucía.
* **Database Tuning:** Optimised database performance using advanced PL/SQL scripts.
* **Agile Delivery:** Applied Scrum methodology in an agile team environment.
...
* **GUI & Legacy Maintenance:** Developed GUI prototypes and maintained legacy systems for public healthcare and social services projects.
